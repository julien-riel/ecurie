 ...
 *
 * Le cadre existe parce que `href: null` est un **état normal** au 4.3 — aucune
 * route ne sert encore les fichiers de job. Sans lui, chaque composant devrait
 * répéter la même retenue, et l'un d'eux finirait par afficher une zone blanche,
 * qui est le seul échec que l'utilisateur ne peut pas diagnostiquer.
 *
 ...
 * fichiers n'existe, et l'aiguillage ne serait éprouvé qu'au 4.4.
 */
      ...
      {href ? null : (
        <>
          ...
          <p className="ecurie-etat-champ">
            fichier non résolu — les sorties de job arrivent avec l'écran Atelier (tâche 4.4)
          </p>
        </>
      )}
    </figure>
